...
export const AVAILABLE_MODELS: ModelOption[] = [
    ...
    },
    {
        ...
        variants: [
            { id: 'claude-sonnet-4.5', name: 'Claude Sonnet 4.5', provider: 'anthropic', icon: <ModelIcon src="/claude 2.jpg" fallback="🎭" /> },
            { id: 'claude-4.5-haiku', name: 'Claude Haiku 4.5', provider: 'anthropic', icon: <ModelIcon src="/claude 2.jpg" fallback="⚡" /> }
        ]
    },
    {
        id: 'gemini-3.0-pro',
        ...
        variants: [
            { id: 'gemini-3-flash', name: 'Gemini 3 Flash', provider: 'google', icon: <ModelIcon src="/gemini.png" fallback="⚡" className="scale-125" /> }
        ]
    },
    {
        id: 'grok-4-2',
...
export const MASTER_MODELS = [
    ...
    { id: 'gemini-3.0-pro', name: 'Gemini 3', icon: <ModelIcon src="/gemini.png" fallback="✨" /> },
]
